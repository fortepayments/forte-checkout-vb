This sample code will demonstrate how to create a simple Pay Now button for Checkout using VB. NET. 

Change the Secure Transaction Key and API Login ID located in the the pay.aspx.vb file.
